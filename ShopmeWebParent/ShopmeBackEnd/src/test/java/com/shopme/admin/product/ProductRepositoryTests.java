...
public class ProductRepositoryTests {
    ...
    public void testCreateProduct() {
        ...
        product.setName("MacBook Air Laptop");
        product.setAlias("macbook_air_laptop");
        product.setShortDescription("Short description for MacBook Air");
        product.setFullDescription("Full description for MacBook Air");
